...
<p>
<div class="data_title"><b>Test Data Bulk Refresh Results</b></div>
</p>
...
<table class="table_data">
	<tr>
		...
		<td class="cell header_red" style='width:100pt; background:#28aafa'>
			<b><i><div class="title" style='text-align:center'>Imported Records</div></i></b>
		</td>
	</tr>
	<#list items as item>
		<tr>
			...
			<#else>
				<td class="cell" style='width:100pt'><div class="title" style='text-align:center'>${item.exception}</div></td>
			</#if>
		</tr>
	</#list>
</table>
