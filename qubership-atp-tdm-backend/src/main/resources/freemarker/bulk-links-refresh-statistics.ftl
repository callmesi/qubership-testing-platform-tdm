...
<p>
<div class="data_title"><b>Test Data Bulk Links Refresh Results</b></div>
</p>
...
<table class="table_data">
	<tr>
		...
		<td class="cell header_red" style='width:100pt; background:#28aafa'>
			<b><i><div class="title">Column Name</div></i></b>
		</td>
	</tr>
	<#list items as item>
			<tr>
				<td class="cell" style='width:280pt'><div class="title">${item.tableTitle}</div></td>
					<td class="cell" style='width:100pt'><div class="title" style='text-align:center'>${item.results.columnNames}</div></td>
			</tr>
	</#list>
</table>
<br><br>
