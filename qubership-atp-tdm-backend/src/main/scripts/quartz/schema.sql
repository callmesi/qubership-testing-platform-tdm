...
where trigger_group = 'cleanup'
and trigger_name not in (select cast (id as varchar) from test_data_cleanup_config);
...
where job_group = 'cleanup'
and job_name not in (select cast (id as varchar) from test_data_cleanup_config);
